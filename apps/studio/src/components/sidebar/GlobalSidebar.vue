...
<script>
  ...
  import { NoSqlDialects } from '@shared/lib/dialects/models'
  ...
  export default {
    ...
    computed: {
      ...mapGetters(['dialect']),
      isSqlDatabase() {
        // NoSQL databases that should not show the Join Query Builder
        return this.dialect && !NoSqlDialects.includes(this.dialect)
      }
    }
  }
</script>
